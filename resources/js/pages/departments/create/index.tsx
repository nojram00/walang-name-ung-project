...
export default function CreateDepartment() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    router.post(route('departments.create'), values)
  }
  ...
  return (
    <DefaultLayout>
        <div className="flex flex-col gap-4">
            ...
            <p className="">Create a new department.</p>
            ...
            <div className='flex items-center justify-center'>
                <form onSubmit={handleSubmit} className="flex flex-1 flex-col gap-4 max-w-lg bg-gray-800 py-20 px-10 rounded-lg">
                    ...
                    <input type="text" className="input border-gray-300 rounded p-2" placeholder='Office' id="name" value={values.office} onChange={(e) => setValues({...values, office : e.target.value})} />
